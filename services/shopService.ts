...
const PRODUCTS: Product[] = [
    ...
    {
        id: 'p14',
        title: 'Koş Logolu T-Shirt',

        image: '/kos-tshirt1.jpg',
        images: [
            '/kos-tshirt1.jpg',
            '/kos-tshirt2.jpg'
        ],
        description: 'Koş serisi özel tasarım t-shirt. %100 pamuk, oversize kesim.',
    ...
    {
        id: 'p13',
        title: 'Obez Logolu Hoodie',

        image: '/obez-sweatshirt.jpg',
        images: [
            '/obez-sweatshirt.jpg',
            '/obez-sweatshirt2.jpg',
            '/obez-sweatshirt3.jpg'
        ],
        description: 'Obez serisi özel tasarım hoodie. %100 pamuk, rahat kesim.',
    ...
    {
        id: 'p15',
        title: 'Atarlı Logolu Bez Torba',

        image: '/atarli-torba1.jpg',
        images: ['/atarli-torba1.jpg', '/atarli-torba2.jpg'],
        description: 'Atarlı serisi özel tasarım bez torba. %100 pamuk, dayanıklı kumaş.',
