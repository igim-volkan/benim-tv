...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose, watchedCount, watchlistCount }) => {
    ...
    return (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/90 p-4">
            <div className="w-full max-w-3xl bg-neutral-900 border-4 border-white p-1 shadow-[10px_10px_0px_#000]">

                {/* Header */}
                <div className="bg-white text-black px-4 py-2 flex justify-between items-center font-bold text-2xl mb-1">
                ...
                {/* Content */}
                <div className="bg-black border-2 border-neutral-700 p-8 text-white min-h-[400px] flex flex-col justify-center">
                    <h2 className="text-3xl sm:text-4xl text-yellow-400 font-bold mb-6 leading-none tracking-wide border-b-4 border-blue-600 inline-block pb-2">
                        SPEND YOUR TIME WATCHING GREAT MOVIES,<br />
                        NOT SEARCHING FOR THEM.
                    </h2>

                    <div className="space-y-4 text-xl sm:text-2xl font-medium leading-relaxed text-neutral-300">
                        <p>
                        ...
                        <div className="mt-8 border-t-2 border-neutral-800 pt-6 flex flex-wrap gap-8 justify-center font-mono text-lg">
                            <div className="flex items-center gap-2">
                                <span className="text-yellow-400 font-bold text-xl">100</span>
                                <span className="text-white">İZLENEN FİLMLER</span>
                                <span className="text-yellow-400 font-bold text-sm bg-neutral-900 px-2 py-1 border border-neutral-700 ml-1">
                                    {watchedCount} FİLM
                                </span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-yellow-400 font-bold text-xl">200</span>
                                <span className="text-white">İZLENECEK FİLMLER</span>
                                <span className="text-yellow-400 font-bold text-sm bg-neutral-900 px-2 py-1 border border-neutral-700 ml-1">
                                    {watchlistCount} FİLM
                                </span>
                            </div>
